...
import cat.socmobilitat.alteraciones.frontend.AltFrontendApp;
import cat.socmobilitat.alteraciones.frontend.domain.Authority;
import cat.socmobilitat.alteraciones.frontend.domain.User;
import cat.socmobilitat.alteraciones.frontend.repository.AuthorityRepository;
...
import cat.socmobilitat.alteraciones.frontend.web.rest.errors.ExceptionTranslator;
import cat.socmobilitat.alteraciones.frontend.web.rest.vm.KeyAndPasswordVM;
import cat.socmobilitat.alteraciones.frontend.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = AltFrontendApp.class)
