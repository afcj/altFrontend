...
@Configuration
@EnableJpaRepositories("cat.socmobilitat.alteraciones.frontend.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("cat.socmobilitat.alteraciones.frontend.repository.search")
